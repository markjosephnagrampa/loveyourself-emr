...
<ul class="pagination">
	  <li id="n_page1" class="active"><a href="javascript:n_change('1');">Step 1</a></li>
	  <li id="n_page2"><a href="javascript:n_change('2');">Step 2</a></li>
	  <li id="n_page3"><a href="javascript:n_change('3');">Step 3</a></li>
	  <li id="n_page4"><a href="javascript:n_change('4');">Step 4</a></li>
	  <li id="n_page5"><a href="javascript:n_change('5');">Step 5</a></li>
	  <li id="n_page6"><a href="javascript:n_change('6');">Step 6</a></li>
	  <li id="n_page7"><a href="javascript:n_change('7');">Step 7</a></li>
	  <li id="n_page8"><a href="javascript:n_change('8');">Step 8</a></li>
	  <li id="n_page9"><a href="javascript:n_change('9');">Step 9</a></li>
	  <li id="n_page10"><a href="javascript:n_change('10');">Step 10</a></li>
	  <li id="n_page11"><a href="javascript:n_change('11');">Step 11</a></li>
...
<div class="n_step" id="n_step1">
	...
	?>
	<ul class="pager">
	    <li class="next"><a href="javascript:n_change('2');" id="back3">Next</a></li>
	 </ul>

</div> <!-- end of step 1-->
<div class="n_step" id="n_step2">
<div class="table-responsive">
	...
	<ul class="pager">
	    <li class="previous"><a href="javascript:n_change('1');" id="back3">Previous</a></li>
	    <li class="next"><a href="javascript:n_change('3');" id="back3">Next</a></li>
	 </ul>

</div><!-- end of step 2-->
	 
<div class="n_step" id="n_step3">
...
<ul class="pager">
    <li class="previous"><a href="javascript:n_change('2');" id="back3">Previous</a></li>
    <li class="next"><a href="javascript:n_change('4');" id="back3">Next</a></li>
 </ul>

</div><!-- end of step 3-->
<div class="n_step" id="n_step4">
<div class="table-responsive">
	<?php echo form_fieldset('<strong>PERSONAL INFORMATION SHEET (FORM A)</strong>');?>
	<table class="table table-bordered">
	...
	<ul class="pager">
	    <li class="previous"><a href="javascript:n_change('3');" id="back3">Previous</a></li>
	    <li class="next"><a href="javascript:n_change('5');" id="back3">Next</a></li>
	 </ul>
</div>
</div> <!-- end of step 4-->

<div class="n_step" id="n_step5">
<div class="table-responsive">
<?php 
...
<?php echo form_fieldset_close(); ?>
	...
	<ul class="pager">
	    <li class="previous"><a href="javascript:n_change('4');" id="back3">Previous</a></li>
	    <li class="next"><a href="javascript:n_change('6');" id="back3">Next</a></li>
	 </ul>

</div><!--end of step 5-->


<div class="n_step" id="n_step6">
<div class="table-responsive">
...
<?php echo form_fieldset_close(); ?>
	...
	<ul class="pager">
	    <li class="previous"><a href="javascript:n_change('5');" id="back3">Previous</a></li>
	    <li class="next"><a href="javascript:n_change('7');" id="back3">Next</a></li>
	 </ul>

</div><!--end of step 6-->
<div class="n_step" id="n_step7">
<div class="table-responsive">
<?php echo form_fieldset('PERSONAL INFORMATION SHEET (FORM A)'); ?>
<table class="table table-bordered">
	<tr>
...
<table class="table table-bordered">
	...
	<ul class="pager">
	    <li class="previous"><a href="javascript:n_change('7');" id="back3">Previous</a></li>
	    <li class="next"><a href="javascript:n_change('9');" id="back3">Next</a></li>
	 </ul>

</div><!--end of step 8-->
<div class="n_step" id="n_step9">
<div class="table-responsive">
<?php echo form_fieldset('PERSONAL INFORMATION SHEET (FORM A)'); ?>
<table class="table table-bordered">
	<tr>
...
<table class="table table-bordered">
	...
	<tbody>
		<tr><td><p>21</p></td>
			...
			<td colspan=3><select class="form-control" id="facility_name"
				name="facility_name">
...
<ul class="pager">
    <li class="previous"><a href="javascript:n_change('9');" id="back3">Previous</a></li>
    <li class="next"><a href="javascript:n_change('11');" id="back3">Next</a></li>
 </ul>

</div><!--end of step 10-->
<div class="n_step" id="n_step11">
<?php echo form_fieldset('PERSONAL INFORMATION SHEET (FORM A)');?>
<table class="table table-bordered">
	<thead><tr>
...
<ul class="pager">
    <li class="previous"><a href="javascript:n_change('10');" id="back3">Previous</a></li>
   
 </ul>

<a href='<?php echo base_url();?>site/nurse_profile'><?php
$data = array(
    'name' => 'backBtn',
    'id' => 'backBtn',
    'value' => 'Back',
